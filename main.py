...
def attack(char_name: str, char_class: str) -> str:
    '''Return a string, containing character name and attack damage.'''
...
def defence(char_name: str, char_class: str) -> str:
    '''Return a string, containing character name and blocked damage.'''
    if char_class == 'warrior':
...
def special(char_name: str, char_class: str) -> str:
    '''Return a string, containing character name and special ability value.'''
    if char_class == 'warrior':
...
def start_training(char_name: str, char_class: str) -> str:
    '''Print character class and start training.'''
    if char_class == 'warrior':
...
def choice_char_class() -> str | None:
    '''Return character class, chosen by user.'''
    approve_choice = None
    char_class = None
